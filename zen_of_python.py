# El Zen de Python se compone por los 20 principios de software para escribir tu código de manera clara, sencilla y precisa. Estos son:

# Si escribimos en la consola esto, nos saldrá el Zen de python
# >>> import this
